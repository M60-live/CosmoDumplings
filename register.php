...
<section id="contact" class="section">
  <div class="container">
    <div class="row title text-center">
      <h2 class="margin-top white">Register Online</h2>
      <h4 class="light white">Make orders easy and fast by registering with us!</h4>
      <?php
    ...
    <div class="row ">
      <div class="col-md-7 no-padding col-md-offset-5 text-center">
        <form action="actions.php" method="post" class="popup-form">
          ...
          <input type="text" name="surname" class="form-control form-white" placeholder="Surname" required />
          <input type="text" name="contact" class="form-control form-white" placeholder="Mobile number" required /><br>
          <input type="password" name="password" class="form-control form-white" placeholder="Create Password" required />
          <input type="password" name="password1" class="form-control form-white" placeholder="Retype Password" required />
